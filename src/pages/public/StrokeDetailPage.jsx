      ...
      <PublicSection title="Coach-approved reporting">
        <div className="grid gap-5 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {['What we saw', 'Why it matters', 'What to feel', 'Recommended drill'].map(item => (
              <div key={item} className="rounded-2xl border border-slate-200 bg-white p-4 text-sm font-bold text-slate-900 shadow-sm">
                {item}
              </div>
            ))}
          </div>
