    ...
    <PublicLayout>
      ...
      <PublicHero
        ...
        actions={
          <>
            ...
            <Link to="/pricing" className="rounded-lg border border-slate-300 bg-white px-5 py-3 text-center text-sm font-semibold text-slate-800 hover:border-slate-400 hover:bg-slate-50">See pilot options</Link>
          </>
        }
      />
      ...
      <PublicSection subtle title="For clubs: a system, not just another video folder." description="Repeatable coaching language across squads and coaches, inside one private club workspace.">
        <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6 ">
            <div className="text-xs font-bold uppercase tracking-[0.24em] text-sky-700">One report structure</div>
            ...
            <Link to="/sample-report" className="mt-6 inline-flex items-center rounded-lg bg-slate-950 px-5 py-3 text-sm font-semibold text-white hover:bg-slate-800">
      ...
      <PublicSection subtle title="You stay in control of every finding." description="Swim Sight 3D is a manual review workspace — the coach marks moments, draws, and writes every finding before it reaches a swimmer report. We set each club pilot up directly with your coaching team.">
        <div className="flex flex-wrap gap-3">
          <Link to="/coach-approved-ai" className="inline-flex rounded-lg bg-slate-950 px-5 py-3 text-sm font-semibold text-white hover:bg-slate-800">
            Read about trust and privacy
          </Link>
          <Link to="/pricing" className="inline-flex rounded-lg border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-slate-800 hover:border-slate-400 hover:bg-slate-50">
            Book a club pilot
          </Link>
        </div>
      </PublicSection>
