...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { item: 'Swimmer Trends', note: 'Score and repeated technical focus over time, only when enough finalised reports exist' },
    ],
  },
  {
    icon: Wrench,
    ...
    items: [
      ...
      { item: 'Hydrodynamic risk cues', note: 'Coach-reviewed body-line/resistance cues only. Estimate language; not lab-measured force' },
      { item: 'Multi-angle upload UI', note: 'Upload workflow exists, but V1 AI processes a single primary angle only' },
      { item: '3D model asset uploads via Reference Library', note: 'Upload form exists; full pipeline in progress' },
      { item: 'Shared annotation export in PDF report', note: 'Coach-reviewed annotations marked for report inclusion; browser print layout remains the supported V1 export path' },
    ],
  },
  {
    icon: FlaskConical,
  ...
  },
  {
    ...
    items: [
      ...
      { item: 'Advanced resistance modelling', note: 'Current system is a coaching estimate only. Lab-grade resistance modelling requires controlled testing or CFD simulation' },
      ...
      { item: 'Production-grade 3D model viewer', note: 'Deferred until reference assets, permissions, and swimmer-specific model pipeline are reliable' },
